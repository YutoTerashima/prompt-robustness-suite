...
def test_project_specific_maturity_modules_import():
    import prompt_robustness_suite.perturbations as _perturbations
    import prompt_robustness_suite.regression_gates as _regression_gates
    import prompt_robustness_suite.policy_variants as _policy_variants
